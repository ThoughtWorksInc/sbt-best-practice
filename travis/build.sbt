...
libraryDependencies += "com.thoughtworks.dsl" %% "keywords-continue" % "1.0.0-RC22-41-7fd570b9"

libraryDependencies += "com.thoughtworks.dsl" %% "keywords-each" % "1.0.0-RC22-41-7fd570b9"

libraryDependencies += "com.thoughtworks.dsl" %% "keywords-return" % "1.0.0-RC22-41-7fd570b9"

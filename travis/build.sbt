...
libraryDependencies += "com.thoughtworks.dsl" %% "keywords-continue" % "1.0.0-RC22+35-5d731d45"

libraryDependencies += "com.thoughtworks.dsl" %% "keywords-each" % "1.0.0-RC22+35-5d731d45"

libraryDependencies += "com.thoughtworks.dsl" %% "keywords-return" % "1.0.0-RC22+35-5d731d45"
